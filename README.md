...
IP and MAC address spoofing menu for Kali
...
```bash
git clone https://github.com/willlccasey/kali-ip-mac-changer.git
cd kali-ip-mac-changer
./install.sh
```
...
```bash
gh repo clone willlccasey/kali-ip-mac-changer
cd kali-ip-mac-changer && ./install.sh
```
